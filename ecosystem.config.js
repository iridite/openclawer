  ...
  apps: [
    {
      ...
      max_memory_restart: "1G", // 内存泄漏保护：超过1G自动重启

      // 4. 日志重定向
      // 注意：请务必提前使用 mkdir -p 创建好 logs 这个文件夹，否则 PM2 会报错！
      error_file: "/var/apps/oc-deploy/target/data/logs/openclaw-error.log",
      out_file: "/var/apps/oc-deploy/target/data/logs/openclaw-out.log",
